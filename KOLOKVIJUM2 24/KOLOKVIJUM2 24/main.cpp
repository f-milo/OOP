...
void main() 
{
	...
	/*
Опште напомене за све класе :
-Атрибути не могу бити јавни.
- Креирати све потребне јавне методе које ће обезбедити да програм ради(укључујући
	...
	- Забрањена је употреба уграђеног типа string.
	Задатак:
